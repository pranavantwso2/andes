 ...
 * must not be called:
 * <ol>
 * <li> {@link java.nio.ByteBuffer#clear()} </li>
 * <li> {@link java.nio.ByteBuffer#compact()} </li>
 * <li> {@link java.nio.ByteBuffer#flip()} </li>
 * <li> {@link java.nio.ByteBuffer#mark()} </li>
 * </ol>
 * </p>
 */
public interface Transport extends Endpoint
{
     ...
     * {@link org.apache.qpid.proton.engine.Sasl} object.
     *
     ...
     * {@link org.apache.qpid.proton.engine.Ssl} object, regardless of the parameters supplied.
     *
     ...
     * @return an {@link org.apache.qpid.proton.engine.Ssl} object representing the SSL session.
     */
    Ssl ssl(SslDomain sslDomain, SslPeerDetails sslPeerDetails);

    /**
     * As per {@link #ssl(org.apache.qpid.proton.engine.SslDomain, SslPeerDetails)} but no attempt is made to resume a previous SSL session.
     */
