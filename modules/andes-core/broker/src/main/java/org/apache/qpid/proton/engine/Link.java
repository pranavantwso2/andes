 ...
 *
 * Sender settle mode - {@link org.apache.qpid.proton.amqp.transport.SenderSettleMode#MIXED}.
 * Receiver settle mode - {@link org.apache.qpid.proton.amqp.transport.ReceiverSettleMode#FIRST}
 *
...
public interface Link extends Endpoint
{
    ...
    /**
     * Expected to be used in a similar manner to {@link #setSource(org.apache.qpid.proton.amqp.transport.Source)}
     */
    void setTarget(Target address);

    /**
     * @see #setSource(org.apache.qpid.proton.amqp.transport.Source)
     */
    Source getRemoteSource();

    /**
     * @see #setTarget(org.apache.qpid.proton.amqp.transport.Target)
     */
     ...
     *
     * In order to be AMQP compliant the application is responsible for honouring the settlement mode. See {@link org.apache.qpid.proton.engine.Link}.
     */
    void setSenderSettleMode(SenderSettleMode senderSettleMode);

    /**
     * @see #setSenderSettleMode(org.apache.qpid.proton.amqp.transport.SenderSettleMode)
     */
     ...
     *
     * Used in analogous way to {@link #setSenderSettleMode(org.apache.qpid.proton.amqp.transport.SenderSettleMode)}
     */
    void setReceiverSettleMode(ReceiverSettleMode receiverSettleMode);

    /**
     * @see #setReceiverSettleMode(org.apache.qpid.proton.amqp.transport.ReceiverSettleMode)
     */
