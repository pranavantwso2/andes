...
class DefaultSslEngineFacade implements ProtonSslEngine
{
     ...
     * than that provided by {@link javax.net.ssl.SSLSession#getApplicationBufferSize()} otherwise
     * {@link javax.net.ssl.SSLEngineResult.Status#BUFFER_OVERFLOW} will result on {@link javax.net.ssl.SSLEngine#unwrap()}.
