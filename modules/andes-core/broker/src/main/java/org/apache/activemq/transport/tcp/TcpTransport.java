...
public class TcpTransport extends TransportThreadSupport implements Transport, Service, Runnable {
     ...
     * @throws java.net.SocketException, IllegalArgumentException if setting the options
     ...
     * @throws java.net.SocketException if the system does not support setting the
     *         Traffic Class.
