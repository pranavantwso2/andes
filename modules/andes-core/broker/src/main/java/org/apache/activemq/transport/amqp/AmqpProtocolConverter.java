...
class AmqpProtocolConverter implements IAmqpProtocolConverter {
    ...
    public void onFrame(Buffer frame) throws Exception {
        while (frame.length > 0) {
            try {
                ...
                handleException(new Exception("Could not decode AMQP frame: " + frame+"\n"+e));
                return;
            }
    ...
    private ActiveMQDestination lookupSubscription(String subscriptionName) throws Exception {
