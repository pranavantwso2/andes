...
/**
 * Thin wrapper around an {@link javax.net.ssl.SSLEngine}.
 */
public interface ProtonSslEngine
{
    /**
     * @see javax.net.ssl.SSLEngine#wrap(java.nio.ByteBuffer, java.nio.ByteBuffer)
     *
    ...
    /**
     * @see javax.net.ssl.SSLEngine#unwrap(java.nio.ByteBuffer, java.nio.ByteBuffer)
     *
     ...
     * packet {@link javax.net.ssl.SSLEngineResult.Status#BUFFER_UNDERFLOW} occurs.  If underflow occurs the
     * pointers within both src and dst are unchanged and the bytesConsumed and
     * bytesProduced on the returned result are zero.
    */
