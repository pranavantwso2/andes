...
public class SslTransportServer extends TcpTransportServer {
     ...
     * @throws java.io.IOException passed up from TcpTransportFactory.
     * @throws java.net.URISyntaxException passed up from TcpTransportFactory.
     */
     ...
     *
     * @throws java.io.IOException passed up from TcpTransportServer.
     */
