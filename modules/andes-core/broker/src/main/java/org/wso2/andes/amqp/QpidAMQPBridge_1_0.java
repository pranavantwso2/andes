...
public class QpidAMQPBridge_1_0 {

    private static Log log = LogFactory.getLog(QpidAMQPBridge_1_0.class);
    private static QpidAMQPBridge_1_0 qpidAMQPBridge_1_0;
    /**
    ...
    public static synchronized QpidAMQPBridge_1_0 getInstance(){
        if(qpidAMQPBridge_1_0 == null){
            qpidAMQPBridge_1_0 = new QpidAMQPBridge_1_0();
        }

        return  qpidAMQPBridge_1_0;
    }

    public QpidAMQPBridge_1_0(){
