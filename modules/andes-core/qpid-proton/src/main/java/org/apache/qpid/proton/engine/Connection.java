 ...
 * {@link #sessionHead(java.util.EnumSet, java.util.EnumSet)}, {@link #linkHead(java.util.EnumSet, java.util.EnumSet)}
...
public interface Connection extends Endpoint
{
     ...
     *
     * @see org.apache.qpid.proton.engine.Session#next(java.util.EnumSet, java.util.EnumSet)
     */
     ...
     *
     * @see org.apache.qpid.proton.engine.Link#next(java.util.EnumSet, java.util.EnumSet)
     */
     ...
     *
     * @see org.apache.qpid.proton.engine.Receiver#recv(byte[], int, int)
     * @see org.apache.qpid.proton.engine.Delivery#settle()
     * @see org.apache.qpid.proton.engine.Delivery#getWorkNext()
     */
