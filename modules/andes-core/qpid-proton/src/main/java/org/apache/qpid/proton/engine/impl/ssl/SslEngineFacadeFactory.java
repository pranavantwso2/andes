...
public class SslEngineFacadeFactory
{
    ...
    /**
     * The protocol name used to create an {@link javax.net.ssl.SSLContext}, taken from Java's list of
    ...
    /**
     * Returns a {@link org.apache.qpid.proton.engine.impl.ssl.ProtonSslEngine}. May cache the domain's settings so callers should invoke
